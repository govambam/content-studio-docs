...
| `FRONTEND_URL` | optional (defaults to `http://localhost:5173`) | `apps/api/src/index.ts` | CORS `origin` allowlist **and** base URL for deep-links in Slack notification messages. Set to the web app's public URL in prod. |
