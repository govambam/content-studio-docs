...
This flag gates the **Slack Notifications** button in the sidebar, which
opens the configuration modal for Slack ticket status notifications.
...
See [Slack integration](./slack.md) for the full feature description.
